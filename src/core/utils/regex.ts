 ...
 */
export function createWordBoundaryPattern(word: string, flags: string = 'gi'): RegExp {
 ...
 * @returns Compiled RegExp
 */
export function createAlternationPattern(strings: string[], flags: string = 'g'): RegExp {
